...
export const TYPES = [
        ...
        {id: 'health', name: 'Santé', values: ['dentist','doctor','hospital','pharmacy','physiotherapist']},
        {id: 'culture', name: 'Activités culturelles', values: ['museum','movie_theater','art_gallery','library']},
        {id: 'outdoor', name: 'Activités plein air', values: ['stadium','park','amusement_park','zoo']}
];
